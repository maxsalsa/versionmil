...
export default function CrearPlantillaPage() {
  ...
  const [items, setItems] = useState<Item[]>([{ id: 1, cantidad: "", medida: "Unidad", articulo: "", valor: "" }])
  ...
  const handleGuardar = () => {
    console.log("[v0] Guardando plantilla:", { nombre, descripcion, items })
  ...
  return (
    <div className="min-h-screen bg-neutral-50 pb-20">
      ...
      <main className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="mt-8">
          <h3 className="text-xl font-bold mb-4 text-gray-900">Artículos</h3>
                  ...
                  <tr key={item.id} className="border-t border-gray-200">
                    <td className="p-4">
                      <div className="flex gap-2">
                        ...
                        <select
                          ...
                          className="px-3 py-2 border-2 border-gray-300 rounded-lg bg-white focus:outline-none focus:border-blue-600"
                        >
                    ...
                    <td className="p-4">
                      <input
                        ...
                        className="w-32 px-3 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-600"
                      />
                    </td>
                    ...
                    <td className="p-4">
                      <button
                        ...
                        className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-red-100 text-red-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6">
          <div className="flex justify-between items-center">
            <span className="text-xl font-bold text-gray-900">Monto Total:</span>
            <span className="text-2xl font-bold text-blue-600">₵{calcularTotal().toLocaleString()}</span>
          </div>
        </div>
